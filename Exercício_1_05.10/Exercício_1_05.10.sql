...
select tb_personagens.nome, tb_personagens.poder_de_ataque, tb_personagens.poder_de_defesa, tb_personagens.vida, tb_classes.nivel, tb_classes.patente from tb_personagens
	inner join tb_classes on tb_classes.id = tb_personagens.id_classes
            where tb_classes.patente like "%Platina%"
